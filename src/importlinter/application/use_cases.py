...
def build_dot_graph(
    ...
    Args:
        ...
        hide_isolated: whether to remove nodes that have no incoming or outgoing edges.
    """
    ...
    if hide_isolated:
        linked_nodes = {e.source for e in dot.edges} | {e.destination for e in dot.edges}
        dot.nodes &= linked_nodes
